...
/****** Object:  StoredProcedure [dbo].[usp_GetEllenorzesreVaroList]    Script Date: 2026. 06. 11. 11:09:29 ******/
SET ANSI_NULLS ON
GO
...
CREATE OR ALTER   PROCEDURE [dbo].[usp_GetEllenorzesreVaroList]
...
BEGIN
    ...
    LEFT JOIN dbo.csli_001_proc_data pd
          ...
          AND pd.obsolete = 0
    WHERE
        COALESCE(v.szallitonak_atadhato, 0) = 0
        AND v.current_status_code  <> 'CANCELLED'
